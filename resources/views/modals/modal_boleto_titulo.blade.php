            ...
            <div class=" form-row">
                            <div class="form-group col-lg-3 mt-4">
                                <div class="form-check-inline">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input" id="Sel" name="Sel" value="1">
                                        Baixa/Envio ao Banco
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-lg-3">
                                ...
                                <input type="text" class="form-control text-center" name="Nro_Doc" id="Nro_Doc" required
                                    maxlength="14" min="10">
                                <div class="invalid-feedback">
                                    Por favor, Campo Obrigatório!
                                </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <input type="text" class="form-control text-center" name="Taxa_Juros"
                                    id="Taxa_Juros" onblur="taxa_Juros()" required maxlength="3" min="3" value="0.00">
                                <div class="invalid-feedback">
                                    Por favor, Campo Obrigatório!
                                </div>
                                <div class="valid-feedback">
                            ...
                            <div class="form-group col-lg-3">
                                <b class="ls-label-text" for="Acrescimo">Valor do Acréscimo</b>
                                <input type="text" class="form-control text-center" name="Acrescimo"
                                    id="Acrescimo" onblur="acrescimo()" required maxlength="10" min="3" value="0.00">
                                <div class="invalid-feedback">
                                    Por favor, Campo Obrigatório!
                                </div>
                                <div class="valid-feedback">
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <input type="text" class="form-control text-center" name="Desconto"
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <input type="date" class="form-control text-center" name="Data_Bai"
                                    id="Data_Bai" required>
                                <div class="invalid-feedback">
                                    Por favor, Campo Obrigatório!
                                </div>
                                <div class="valid-feedback">
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <input type="date" class="form-control text-center" name="Data_Liq"
                                    id="Data_Liq" required>
                                <div class="invalid-feedback">
                                    Por favor, Campo Obrigatório!
                                </div>
                                <div class="valid-feedback">
                        ...
                        <div class="form-row">
                            <div class="form-group col-lg-3">
                                ...
                                <input type="text" class="form-control text-center" name="Transacao"
                                    id="Transacao" required maxlength="10" min="1">
                                <div class="invalid-feedback">
                                    Por favor, Campo Obrigatório!
                                </div>
                                <div class="valid-feedback">
