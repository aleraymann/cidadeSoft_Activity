    ...
    <div class="modal-dialog  modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" class="needs-validation" novalidate action="{{url("/CatOSPed/salvar")}}" onsubmit="return checkForm(this);">
            ...
            if (e.keyCode == 13) {
                ...
                return false;
                    ...
                    <div class="form-row">
                        ...
                        <input  class="btn btn-secondary ml-5" id="reset" type='reset' value='Limpar'/>
                    </form>
                </div>
            </div>
