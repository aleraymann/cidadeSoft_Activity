            ...
            <div class="modal-body">
                ...
                @if(!isset($id))
                    <form method="post" class="needs-validation" novalidate
                        action="{{ url("/Empresa/salvar") }}" enctype="multipart/form-data"
                        onsubmit="return checkForm(this);">
                    @else
                        <form method="post" action="{{ url("/Empresa/salvar/$id") }}"
                ...
                <ul class="nav nav-tabs ml-3" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="#diretorios" role="tab" data-toggle="tab"><b>Diretórios e
                                Impressoras</b></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#smtp" role="tab" data-toggle="tab"> <b>SMTP</b></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#ftp" role="tab" data-toggle="tab"><b>FTP</b></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#custos" role="tab" data-toggle="tab"><b>Custos Adicionais</b></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#tributos" role="tab" data-toggle="tab"><b>Tributação</b></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#proxy" role="tab" data-toggle="tab"><b>Proxy</b></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#nfe" role="tab" data-toggle="tab"><b>Nota Fiscal</b></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#contador" role="tab" data-toggle="tab"><b>Contador</b></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#desc" role="tab" data-toggle="tab"><b>Descrição adicional</b></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#adic" role="tab" data-toggle="tab"><b>Dados Adicionais</b></a>
                    </li>
                </ul>
                <!-- Tab panes -->
                <div class="tab-content ">
                        ...
                        <div class="container">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-lg-2">
                                    ...
                                    <input type="text" class="form-control text-center" readonly name="Cidade"
                                        id="Cidade">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                ...
                                <div class="form-group col-lg-1">
                                    ...
                                    <input type="text" class="form-control text-center" readonly name="Estado"
                                        id="Estado" minlength="2" maxlength="2">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-4">
                                    ...
                                    <input type="text" class="form-control text-center" name="CNAE" id="CNAE"
                                        maxlength="10">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                ...
                                <div class="form-group col-lg-4">
                                    ...
                                    <input type="text" class="form-control text-center" name="CliFor_Saida"
                                        id="CliFor_Saida">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                ...
                                <div class="form-group col-lg-4">
                                    ...
                                    <input type="text" class="form-control text-center" name="CliFor_Entrada"
                                        id="CliFor_Entrada">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    ...
                                    <select class="form-control  text-center" id="Vend_TranspPadrao"
                                        name="Vend_TranspPadrao">
                                        <option value="0">Selecione</option>
                                        @foreach($transportadora as $transportadora)
                                            @can("view_transp",$transportadora)
                                                <option value="{{ $transportadora->Codigo }}">
                                                    {{ $transportadora->Nome_Fantasia }}</option>
                                            @endcan
                                        @endforeach
                                    </select>
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-4">
                                    ...
                                    <select class="form-control  text-center" id="Vend_CliForPadrao"
                                        name="Vend_CliForPadrao" required>
                                        <option value="0">Selecione</option>
                                        @foreach($user as $u)
                                    ...
                                    <select class="form-control  text-center" id="Condicao" name="Condicao">
                                        ...
                                        @foreach($cond_pag as $cond_pag)
                                            @can("view_condPag",$cond_pag)
                                                <option value="{{ $cond_pag->Codigo }}">
                                                    {{ $cond_pag->Condicao }}</option>
                                            @endcan
                                        @endforeach
                                    </select>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group col-lg-4">
                                    ...
                                    <select class="form-control  text-center" id="Vend_FormPadrao"
                                        name="Vend_FormPadrao">
                                        <option value="0">Selecione</option>
                                        @foreach($form_pag as $form_pag)
                                            @can("view_formPag",$form_pag)
                                                <option value="{{ $form_pag->Codigo }}">
                                                    {{ $form_pag->Descricao }}</option>
                                            @endcan
                                        @endforeach
                                    </select>
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control text-center" name="Cfg_DataUltExec"
                                        id="Cfg_DataUltExec" value="{{ date('d/m/Y') }}" required
                                        readonly>
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control text-center" name="Cfg_Ultbackup"
                                        id="Cfg_Ultbackup" value="{{ date('d/m/Y') }}" required
                                        readonly>
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                    ...
                    <!--Diretórios -->
                    <div role="tabpanel" class="tab-pane fade" id="diretorios">
                        <div class="container">
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    <b class="ls-label-text" for="Cfg_DirRel">Diretório dos registros</b>
                                    <input type="text" class="form-control text-center" name="Cfg_DirRel"
                                        id="Cfg_DirRel" minlength="5" maxlength="150">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                                ...
                                <div class="form-group col-lg-6">
                                    <b class="ls-label-text" for="Cfg_DirFotoProd">Diretório das Fotos dos
                                        Produtos</b>
                                    <input type="text" class="form-control text-center" name="Cfg_DirFotoProd"
                                        id="Cfg_DirFotoProd" minlength="5" maxlength="150">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    <b class="ls-label-text" for="Cfg_ImpOrcamento">Nome da
                                        Impressora(Orçamentos)</b>
                                    <input type="text" class="form-control text-center" name="Cfg_ImpOrcamento"
                                        id="Cfg_ImpOrcamento" minlength="3" maxlength="20">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control text-center" name="Cfg_ImpPedido"
                                        id="Cfg_ImpPedido" minlength="3" maxlength="20">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control text-center" name="Cfg_ImpOs" id="Cfg_ImpOs"
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control text-center" name="Cfg_ImpNfe"
                                        id="Cfg_ImpNfe" minlength="3" maxlength="20">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control text-center" name="Cfg_ImpEtiq"
                                        id="Cfg_ImpEtiq" minlength="3" maxlength="20">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                                ...
                                <div class="form-group col-lg-6">
                                    <b class="ls-label-text" for="Cfg_ImpEtiqMod">Nome da Impressora(Etiquetas
                                        Modelo1)</b>
                                    <input type="text" class="form-control text-center" name="Cfg_ImpEtiqMod"
                                        id="Cfg_ImpEtiqMod" minlength="3" maxlength="20">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    <b class="ls-label-text" for="Cfg_TranSeq">Num Sequen. das Transacoes Fiscais
                                        Financeiras</b>
                                    <input type="number" class="form-control text-center" name="Cfg_TranSeq"
                                        id="Cfg_TranSeq" maxlength="10">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="smtp">
                        <div class="container">
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    <b class="ls-label-text" for="SMTP_CorpoEmail">Corpo da Mensagem a ser enviada
                                        por email</b>
                                    <input type="text" class="form-control text-center" name="SMTP_CorpoEmail"
                                        id="SMTP_CorpoEmail">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control text-center" name="SMTP_Serv" id="SMTP_Serv"
                                        maxlength="50">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-2">
                                    ...
                                    <input type="text" class="form-control text-center" name="SMTP_Porta"
                                        id="SMTP_Porta" minlength="1" maxlength="5">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control text-center" name="SMTP_Usuario"
                                        id="SMTP_Usuario" minlength="5" maxlength="45">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                                ...
                                <div class="form-group col-lg-4">
                                    ...
                                    <input type="password" class="form-control text-center" name="SMTP_Senha"
                                        id="SMTP_Senha" minlength="5" maxlength="45">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" id="SMTP_Seguro"
                                                name="SMTP_Seguro" value="1">Utiliza Sistema de Seguranca SSL ou
                                            TLS?
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group col-lg-6">
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" id="SMTP_EmailCopia"
                                                name="SMTP_EmailCopia" value="1">Enviar cópia de email para e
                                            Empresa?
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-4">
                                    ...
                                    <input type="text" class="form-control text-center" name="WS_Plataforma"
                                        id="WS_Plataforma" maxlength="15">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                                ...
                                <div class="form-group col-lg-4">
                                    ...
                                    <input type="text" class="form-control text-center" name="WB_Endereco"
                                        id="WB_Endereco" maxlength="150">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                                ...
                                <div class="form-group col-lg-4">
                                    ...
                                    <input type="text" class="form-control text-center" name="WS_WSDL" id="WS_WSDL"
                                        maxlength="150">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control text-center" name="WS_Usuario"
                                        id="WS_Usuario" minlength="4" maxlength="45">
                                    <div class="invalid-feedback">
                                        Mínimo 4 caracteres!
                                    </div>
                                    <div class="valid-feedback">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="password" class="form-control text-center" name="WS_Senha"
                                        id="WS_Senha" minlength="4" maxlength="45">
                                    <div class="invalid-feedback">
                                        Mínimo 4 caracteres!
                                    </div>
                                    <div class="valid-feedback">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="custos">
                        <div class="container mt-2">
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    <b class="ls-label-text" for="Fin_CFixos">Percentual de Custos Fixos para
                                        Cálculo Markup</b>
                                ...
                                <div class="form-group col-lg-6">
                                    <b class="ls-label-text" for="Fin_Desloc">Preço Deslocamento para Cálculo
                                        Markup</b>
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    <b class="ls-label-text" for="Fin_Comissao">Percentual de Comissão para Cálculo
                                        Markup</b>
                                ...
                                <div class="form-group col-lg-6">
                                    <b class="ls-label-text" for="Fin_Inad">Percentual de Inadimplência para Cálculo
                                        Markup</b>
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    <b class="ls-label-text" for="Fin_Lucro">Percentual Médio de Lucratividade para
                                        Calculo
                                        Markup</b>
                                ...
                                <div class="form-group col-lg-6">
                                    <b class="ls-label-text" for="Fin_DescPV">Percentual de Desconto no Preço à
                                        Prazo para
                                        Chegar no Preço à Vista</b>
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    <b class="ls-label-text" for="Fin_PerDano">Percentual de Perdas e Danos para
                                        Cálculo
                                        Markup</b>
                                ...
                                <div class="form-group col-lg-6">
                                    <b class="ls-label-text" for="Fin_JurosPadrao">Juros a ser cobrado no Contas a
                                        Receber do
                                        Sistema</b>
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    <b class="ls-label-text" for="Fin_MultaPadrao">Multa padrão a ser aplicada no
                                        atraso de
                                        títulos</b>
                        ...
                        <div class="container mt-2">
                            <div class="form-row">
                                <div class="form-group col-lg-4">
                                    ...
                                    <select class="form-control text-center" id="Fisc_Tributacao"
                                        name="Fisc_Tributacao">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-lg-4">
                                    ...
                                    <input type="text" class="form-control text-center" name="Fisc_Simples"
                                        id="Fisc_Simples" maxlength="3" minlength="1" value="0.00">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                        ...
                        <div class="container mt-2">
                            <div class="form-row">
                                <div class="form-group col-lg-8">
                                    ...
                                    <input type="text" class="form-control  text-center" name="NFe_Proxy" id="NFe_Proxy"
                                        maxlength="150">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                ...
                                <div class="form-group col-lg-4">
                                    ...
                                    <input type="text" class="form-control text-center" name="NFe_Porta" id="NFe_Porta"
                                        maxlength="5">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control  text-center" name="NFe_Usuario"
                                        id="NFe_Usuario" minlength="4" maxlength="50">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="password" class="form-control  text-center" name="NFe_Senha"
                                        id="NFe_Senha" minlength="4" maxlength="50">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                        ...
                        <div class="container mt-2">
                            <div class="form-row">
                                <div class="form-group col-lg-8">
                                    ...
                                    <input type="text" class="form-control text-center" name="FTP_Endereco"
                                        id="FTP_Endereco" maxlength="150">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control text-center" name="FTP_Usuario"
                                        id="FTP_Usuario" maxlength="50">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="password" class="form-control text-center" name="FTP_Senha"
                                        id="FTP_Senha" maxlength="88">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="nfe">
                        <div class="container mt-2">
                            <div class="form-row">
                                <div class="form-group col-lg-8">
                                    <b class="ls-label-text" for="NFe_DirXML">Diretório dos Schemas e onde serão
                                        salvos os XML
                                        das NFes:</b>
                                    <input type="text" class="form-control  text-center" name="NFe_DirXML"
                                        id="NFe_DirXML" maxlength="150">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-lg-5">
                                    ...
                                    <input type="text" class="form-control  text-center" name="NFe_Modelo"
                                        id="NFe_Modelo" maxlength="3">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                                ...
                                <div class="form-group col-lg-5">
                                    <b class="ls-label-text" for="NFe_Versao">Versão dos Schemas para emissão da
                                        Nota:</b>
                                    <input type="text" class="form-control  text-center" name="NFe_Versao"
                                        id="NFe_Versao" maxlength="4">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-lg-4 ml-2">
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" id="NFe_Valida"
                                                name="NFe_Valida" value="1">Validar Notas de Entrada?
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-lg-12">
                                    <b class="ls-label-text" for="NFe_Obs">Observação a ser impressa no rodapé da
                                        NFe:</b>
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-4">
                                    ...
                                    <input type="text" class="form-control  text-center" name="NFCe_Versao"
                                        id="NFCe_Versao" maxlength="4" value="3.10">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                                ...
                                <div class="form-group col-lg-4">
                                    <b class="ls-label-text" for="NFCe_idToken">Código de Identificação do
                                        Token:</b>
                                    <input type="text" class="form-control  text-center" name="NFCe_idToken"
                                        id="NFCe_idToken" maxlength="11">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                                ...
                                <div class="form-group col-lg-4">
                                    ...
                                    <input type="text" class="form-control  text-center" name="NFCe_CSC" id="NFCe_CSC"
                                        maxlength="45">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-4">
                                    ...
                                    <input type="text" class="form-control  text-center" name="NFe_CertDig"
                                        id="NFe_CertDig" maxlength="45">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                    ...
                    <!-- Contador-->
                    <div role="tabpanel" class="tab-pane fade" id="contador">
                        <div class="container mt-2">
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    <b class="ls-label-text" for="Ctb_Email">Email do Contador(envio XML):</b>
                                    <input type="email" class="form-control  text-center" name="Ctb_Email"
                                        id="Ctb_Email" maxlength="150">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="text" class="form-control  text-center" name="Ctb_ContNome"
                                        id="Ctb_ContNome" maxlength="60" min="3">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-4">
                                    ...
                                    <input type="text" class="form-control  text-center" name="Ctb_ContCRC"
                                        id="Ctb_ContCRC" maxlength="25">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                                ...
                                <div class="form-group col-lg-4">
                                    ...
                                    <input type="text" class="form-control  text-center" name="Ctb_ContINSS"
                                        id="Ctb_ContINSS" maxlength="25">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                                ...
                                <div class="form-group col-lg-4">
                                    ...
                                    <input type="text" class="form-control  text-center" name="Ctb_contCPF"
                                        id="Ctb_contCPF" maxlength="14" onblur="validarCPF(this)">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-4">
                                    ...
                                    <input type="text" class="form-control  text-center" name="Ctb_ContFone"
                                        id="Ctb_ContFone">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                ...
                                <div class="form-group col-lg-4">
                                    ...
                                    <input type="text" class="form-control  text-center" name="Ctb_RegLocal"
                                        id="Ctb_RegLocal" maxlength="100">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                                ...
                                <div class="form-group col-lg-4">
                                    ...
                                    <input type="text" class="form-control  text-center" name="Ctb_RegNumero"
                                        id="Ctb_RegNumero" maxlength="50">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-4">
                                    ...
                                    <input type="text" class="form-control  text-center" name="Ctb_RegData"
                                        id="Ctb_RegData" placeholder="DD/MM/AAAA">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="desc">
                        <div class="container mt-2">
                            <div class="form-row">
                                <div class="form-group col-lg-12">
                                    <b class="ls-label-text" for="Vend_DescAdicOrca">Descrição adicional a ser
                                        impressa no
                                        rodapé dos Orçamentos:</b>
                                    <input type="text" class="form-control  text-center" name="Vend_DescAdicOrca"
                                        id="Vend_DescAdicOrca" maxlength="150">
                                </div>
                                <div class="invalid-feedback">
                                    Por favor, Campo Obrigatório!
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-12">
                                    <b class="ls-label-text" for="Vend_DescAdicPed">Descrição adicional a ser
                                        impressa no rodapé
                                        dos Pedidos:</b>
                                    <input type="text" class="form-control  text-center" name="Vend_DescAdicPed"
                                        id="Vend_DescAdicPed" maxlength="150">
                                </div>
                                <div class="invalid-feedback">
                                    Por favor, Campo Obrigatório!
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-12">
                                    <b class="ls-label-text" for="Vend_DescAdicOS">Descrição adicional a ser
                                        impressa no rodapé
                                        da OS:</b>
                                    <input type="text" class="form-control  text-center" name="Vend_DescAdicOS"
                                        id="Vend_DescAdicOS" maxlength="150">
                                </div>
                                <div class="invalid-feedback">
                                    Por favor, Campo Obrigatório!
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-12">
                                    <b class="ls-label-text" for="Fin_MsgPadrao">Mensagem padrão a ser impressa nos
                                        títulos</b>
                                    <input type="text" class="form-control text-center" name="Fin_MsgPadrao"
                                        id="Fin_MsgPadrao" maxlength="50">
                                </div>
                                <div class="invalid-feedback">
                                    Por favor, Campo Obrigatório!
                                </div>
                        ...
                        <div class="container mt-2">
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" id="Fin_ControlaCaixa"
                                                name="Fin_ControlaCaixa" value="1">Efetuar controle de caixa,
                                            exigindo abertura
                                            e fechamento diário?
                                        </label>
                                    </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-7">
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" id="Fisc_ICMSFixo"
                                                name="Fisc_ICMSFixo" value="1">Utilizar ICMS Fixo, descontando o
                                            percentual nas
                                            Notas de empresa Simples?
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" id="Cfg_PreviewRel"
                                                name="Cfg_PreviewRel" value="1"> Pré Vizualizar Relatórios Emitidos?
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-lg-6">
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" id="Cfg_LembCliAniv"
                                                name="Cfg_LembCliAniv" value="1"> Lembrar Aniversario de Clientes?
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" id="Cfg_PesqCep"
                                                name="Cfg_PesqCep" value="1"> Pesquisa automatica de CEP?
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-lg-6">
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" id="Cfg_IdentChamada"
                                                name="Cfg_IdentChamada" value="1"> Utilizar identificador de
                                            chamadas?
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" id="Cfg_AtuPrecoPrazo"
                                                name="Cfg_AtuPrecoPrazo" value="1">Atualização dos preços a prazo?
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-lg-6">
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" id="Cfg_PermDuplicar"
                                                name="Cfg_PermDuplicar" value="1"> Permite duplicar cadastro do
                                            cliente?
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" id="Vend_AltPrTot"
                                                name="Vend_AltPrTot" value="1">Altera Preco Total nos Orcamentos,
                                            Pedidos e OSs?
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-lg-6">
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" id="Vend_ExibeEst"
                                                name="Vend_ExibeEst" value="1">Exibir a quantidade de Estoque na
                                            tela de Pedido,
                                            OS?
                                        </label>
                                    </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" id="Vend_FreteIncorp"
                                                name="Vend_FreteIncorp" value="1">Valor do Frete incorpora o Total
                                            do Pedido,
                                            OS?
                                        </label>
                                    </div>
                                ...
                                <div class="form-group col-lg-6">
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" id="Vend_AgrupaltPed"
                                                name="Vend_AgrupaltPed" value="1">Agrupar itens lancados duplicados
                                            no Pedido?
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" id="Vend_MudaStatOS"
                                                name="Vend_MudaStatOS" value="1">Mudar Status de Ordem de Servico ao
                                            Faturar?
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-lg-6">
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" id="Vend_BuscObs"
                                                name="Vend_BuscObs" value="1">Utiliza observacoes de produtos nas
                                            buscas?
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" id="Vend_ProgFide"
                                                name="Vend_ProgFide" value="1">Utilizar programa de fidelidade?
                                        </label>
                                    </div>
                                </div>
                                <div class="form-group col-lg-6">
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" id="Vend_FiltroIniMes"
                                                name="Vend_FiltroIniMes" value="1">Filtro do Sistema pelo Inicio do
                                            Mes?
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" id="Vend_BxEstOSOrc"
                                                name="Vend_BxEstOSOrc" value="1"> Baixar Estoque em OS com Situacao
                                            EM
                                            ORCAMENTO?
                                        </label>
                                    </div>
                                ...
                                <div class="form-group col-lg-4">
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" id="Vend_PedSimp"
                                                name="Vend_PedSimp" value="1">Tela simplificada para emissao de
                                            pedidos?
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-7">
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" id="Fin_ComiFrac"
                                                name="Fin_ComiFrac" value="1">Utilizar pagamento de comissão
                                            fracionada aos
                                            vendedores?
                                        </label>
                                    </div>
                                ...
                                <div class="form-group col-lg-5">
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" class="form-check-input" id="Fin_ContrComi"
                                                name="Fin_ContrComi" value="1">Controlar Comissões?
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    <b class="ls-label-text" for="Vend_DiasLocacao">Dias padrão para Lançamento de
                                        Locações:</b>
                                    <input type="text" class="form-control  text-center" name="Vend_DiasLocacao"
                                        id="Vend_DiasLocacao" maxlength="5" value="0">
                                    <div class="invalid-feedback">
                                        Por favor, Campo Obrigatório!
                                    </div>
                                    <div class="valid-feedback">
                                ...
                                <div class="form-group col-lg-6">
                                    <b class="ls-label-text" for="Vend_ProgPtos">Valor base de pontos no prog de
                                        fidelidade:</b>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-lg-4">
                                    <b class="ls-label-text" for="Vend_VlrMinimo">Valor mínimo de hora de
                                        trabalho:</b>
