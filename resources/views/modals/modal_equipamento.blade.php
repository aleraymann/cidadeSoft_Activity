          ...
          <div class=" form-row">
                        ...
                        <div class="form-row">
                            <div class="form-group col-lg-3">
                                ...
                                <input type="text" class="form-control text-center" name="Nro_Serie"
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" class="form-control text-center" name="Equipamento"
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-lg-3">
                                ...
                                <input type="text" class="form-control text-center" name="Nro_Frota"
                                    id="Nro_Frota" placeholder="" minlength="" maxlength="">
                                
                            </div>
                            <div class="form-group col-lg-3">
                                <b class="ls-label-text" for="Fabricacao">Ano de Fabricação:</b>
                                <input type="text" class="form-control text-center" name="Fabricacao"
