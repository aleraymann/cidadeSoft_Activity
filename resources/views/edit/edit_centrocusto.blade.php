...
<a href="{{ url("/Cadastro/centrocusto") }}" class="btn btn-primary ml-3 mb-1">
  ...
  <div class="col-md-12">
      ...
      <div class="modal-body">
        @if(!isset($id))
        <form method="post" class="needs-validation" novalidate action="{{url("/CentroCusto/salvar")}}">
         @else
         <form method="post" action="{{url("/CentroCusto/salvar/$id")}}" enctype="multipart/form-data">
          ...
          <div class="form-row">
            ...
            <a href="{{ url("/Cadastro/centrocusto") }}" class="btn btn-danger ml-3">Cancelar</a>
          </form>
